 ...
 */
class Trs extends \Cosanit\CosanitBundle\Entity\Trs implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Cosanit\\CosanitBundle\\Entity\\Trs' . "\0" . 'id', '' . "\0" . 'Cosanit\\CosanitBundle\\Entity\\Trs' . "\0" . 'taux3mois', '' . "\0" . 'Cosanit\\CosanitBundle\\Entity\\Trs' . "\0" . 'valeur3mois', '' . "\0" . 'Cosanit\\CosanitBundle\\Entity\\Trs' . "\0" . 'taux6mois', '' . "\0" . 'Cosanit\\CosanitBundle\\Entity\\Trs' . "\0" . 'valeur6mois', '' . "\0" . 'Cosanit\\CosanitBundle\\Entity\\Trs' . "\0" . 'taux1an', '' . "\0" . 'Cosanit\\CosanitBundle\\Entity\\Trs' . "\0" . 'valeur1an', '' . "\0" . 'Cosanit\\CosanitBundle\\Entity\\Trs' . "\0" . 'categories'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Trs $proxy) {
