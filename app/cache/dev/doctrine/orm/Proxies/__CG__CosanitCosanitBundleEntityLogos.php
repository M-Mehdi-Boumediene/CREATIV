 ...
 */
class Logos extends \Cosanit\CosanitBundle\Entity\Logos implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Cosanit\\CosanitBundle\\Entity\\Logos' . "\0" . 'id', 'categories', '' . "\0" . 'Cosanit\\CosanitBundle\\Entity\\Logos' . "\0" . 'updateAt', '' . "\0" . 'Cosanit\\CosanitBundle\\Entity\\Logos' . "\0" . 'name', '' . "\0" . 'Cosanit\\CosanitBundle\\Entity\\Logos' . "\0" . 'path', 'file'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Logos $proxy) {
