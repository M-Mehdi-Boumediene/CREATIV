 ...
 */
class Bannieres extends \Cosanit\CosanitBundle\Entity\Bannieres implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Cosanit\\CosanitBundle\\Entity\\Bannieres' . "\0" . 'id', '' . "\0" . 'Cosanit\\CosanitBundle\\Entity\\Bannieres' . "\0" . 'updateAt', '' . "\0" . 'Cosanit\\CosanitBundle\\Entity\\Bannieres' . "\0" . 'name', '' . "\0" . 'Cosanit\\CosanitBundle\\Entity\\Bannieres' . "\0" . 'titre', '' . "\0" . 'Cosanit\\CosanitBundle\\Entity\\Bannieres' . "\0" . 'texte', '' . "\0" . 'Cosanit\\CosanitBundle\\Entity\\Bannieres' . "\0" . 'path', 'file'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Bannieres $proxy) {
