 ...
 */
class Services extends \Cosanit\CosanitBundle\Entity\Services implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Cosanit\\CosanitBundle\\Entity\\Services' . "\0" . 'id', '' . "\0" . 'Cosanit\\CosanitBundle\\Entity\\Services' . "\0" . 'titre', '' . "\0" . 'Cosanit\\CosanitBundle\\Entity\\Services' . "\0" . 'texte', '' . "\0" . 'Cosanit\\CosanitBundle\\Entity\\Services' . "\0" . 'image'];
        }
