 ...
 */
class Assistance1 extends \Cosanit\CosanitBundle\Entity\Assistance1 implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Cosanit\\CosanitBundle\\Entity\\Assistance1' . "\0" . 'id', '' . "\0" . 'Cosanit\\CosanitBundle\\Entity\\Assistance1' . "\0" . 'taux3mois', '' . "\0" . 'Cosanit\\CosanitBundle\\Entity\\Assistance1' . "\0" . 'valeur3mois', '' . "\0" . 'Cosanit\\CosanitBundle\\Entity\\Assistance1' . "\0" . 'taux6mois', '' . "\0" . 'Cosanit\\CosanitBundle\\Entity\\Assistance1' . "\0" . 'valeur6mois', '' . "\0" . 'Cosanit\\CosanitBundle\\Entity\\Assistance1' . "\0" . 'taux1an', '' . "\0" . 'Cosanit\\CosanitBundle\\Entity\\Assistance1' . "\0" . 'valeur1an', '' . "\0" . 'Cosanit\\CosanitBundle\\Entity\\Assistance1' . "\0" . 'categories'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Assistance1 $proxy) {
