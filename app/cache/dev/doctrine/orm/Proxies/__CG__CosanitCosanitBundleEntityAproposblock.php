 ...
 */
class Aproposblock extends \Cosanit\CosanitBundle\Entity\Aproposblock implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Cosanit\\CosanitBundle\\Entity\\Aproposblock' . "\0" . 'id', '' . "\0" . 'Cosanit\\CosanitBundle\\Entity\\Aproposblock' . "\0" . 'titre', '' . "\0" . 'Cosanit\\CosanitBundle\\Entity\\Aproposblock' . "\0" . 'text'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Aproposblock $proxy) {
