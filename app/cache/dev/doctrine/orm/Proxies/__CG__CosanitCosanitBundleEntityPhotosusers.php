 ...
 */
class Photosusers extends \Cosanit\CosanitBundle\Entity\Photosusers implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Cosanit\\CosanitBundle\\Entity\\Photosusers' . "\0" . 'id', '' . "\0" . 'Cosanit\\CosanitBundle\\Entity\\Photosusers' . "\0" . 'updateAt', '' . "\0" . 'Cosanit\\CosanitBundle\\Entity\\Photosusers' . "\0" . 'name', '' . "\0" . 'Cosanit\\CosanitBundle\\Entity\\Photosusers' . "\0" . 'email', '' . "\0" . 'Cosanit\\CosanitBundle\\Entity\\Photosusers' . "\0" . 'path', 'file'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Photosusers $proxy) {
