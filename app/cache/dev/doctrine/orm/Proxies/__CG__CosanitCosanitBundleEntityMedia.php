 ...
 */
class Media extends \Cosanit\CosanitBundle\Entity\Media implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Cosanit\\CosanitBundle\\Entity\\Media' . "\0" . 'id', '' . "\0" . 'Cosanit\\CosanitBundle\\Entity\\Media' . "\0" . 'updateAt', '' . "\0" . 'Cosanit\\CosanitBundle\\Entity\\Media' . "\0" . 'name', '' . "\0" . 'Cosanit\\CosanitBundle\\Entity\\Media' . "\0" . 'path', 'file'];
        }
