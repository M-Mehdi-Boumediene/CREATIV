 ...
 */
class Trs2 extends \Cosanit\CosanitBundle\Entity\Trs2 implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Cosanit\\CosanitBundle\\Entity\\Trs2' . "\0" . 'id', '' . "\0" . 'Cosanit\\CosanitBundle\\Entity\\Trs2' . "\0" . 'taux', '' . "\0" . 'Cosanit\\CosanitBundle\\Entity\\Trs2' . "\0" . 'valeur', '' . "\0" . 'Cosanit\\CosanitBundle\\Entity\\Trs2' . "\0" . 'categories'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Trs2 $proxy) {
