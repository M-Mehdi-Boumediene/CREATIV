 ...
 */
class Docs extends \Cosanit\CosanitBundle\Entity\Docs implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Cosanit\\CosanitBundle\\Entity\\Docs' . "\0" . 'id', '' . "\0" . 'Cosanit\\CosanitBundle\\Entity\\Docs' . "\0" . 'texte'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Docs $proxy) {
