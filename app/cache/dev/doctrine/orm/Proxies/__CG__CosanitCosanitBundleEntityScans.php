 ...
 */
class Scans extends \Cosanit\CosanitBundle\Entity\Scans implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Cosanit\\CosanitBundle\\Entity\\Scans' . "\0" . 'id', '' . "\0" . 'Cosanit\\CosanitBundle\\Entity\\Scans' . "\0" . 'updateAt', '' . "\0" . 'Cosanit\\CosanitBundle\\Entity\\Scans' . "\0" . 'name', '' . "\0" . 'Cosanit\\CosanitBundle\\Entity\\Scans' . "\0" . 'path', 'file'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Scans $proxy) {
