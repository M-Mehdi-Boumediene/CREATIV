 ...
 */
class Pubs extends \Cosanit\CosanitBundle\Entity\Pubs implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Cosanit\\CosanitBundle\\Entity\\Pubs' . "\0" . 'id', '' . "\0" . 'Cosanit\\CosanitBundle\\Entity\\Pubs' . "\0" . 'texte'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Pubs $proxy) {
