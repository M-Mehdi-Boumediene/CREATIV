 ...
 */
class Trs3 extends \Cosanit\CosanitBundle\Entity\Trs3 implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Cosanit\\CosanitBundle\\Entity\\Trs3' . "\0" . 'id', '' . "\0" . 'Cosanit\\CosanitBundle\\Entity\\Trs3' . "\0" . 'taux', '' . "\0" . 'Cosanit\\CosanitBundle\\Entity\\Trs3' . "\0" . 'valeur', '' . "\0" . 'Cosanit\\CosanitBundle\\Entity\\Trs3' . "\0" . 'categories'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Trs3 $proxy) {
