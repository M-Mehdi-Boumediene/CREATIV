 ...
 */
class Slideneufs extends \Cosanit\CosanitBundle\Entity\Slideneufs implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Cosanit\\CosanitBundle\\Entity\\Slideneufs' . "\0" . 'id', '' . "\0" . 'Cosanit\\CosanitBundle\\Entity\\Slideneufs' . "\0" . 'updateAt', '' . "\0" . 'Cosanit\\CosanitBundle\\Entity\\Slideneufs' . "\0" . 'name', '' . "\0" . 'Cosanit\\CosanitBundle\\Entity\\Slideneufs' . "\0" . 'description', '' . "\0" . 'Cosanit\\CosanitBundle\\Entity\\Slideneufs' . "\0" . 'path', 'file'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Slideneufs $proxy) {
