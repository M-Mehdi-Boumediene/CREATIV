 ...
 * defences
 *
 * @ORM\Table(name="defences")
 * @ORM\Entity(repositoryClass="Cosanit\CosanitBundle\Repository\DefencesRepository")
 */
class Defences
{
    /**
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Categories", inversedBy="defences", cascade={"all"})
