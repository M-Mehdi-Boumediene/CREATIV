 ...
 * venals
 *
 * @ORM\Table(name="venals")
 * @ORM\Entity(repositoryClass="Cosanit\CosanitBundle\Repository\VenalsRepository")
 */
class Venals
{
    /**
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Categories", inversedBy="venals", cascade={"all"})
