 ...
 * Assistance1
 *
 * @ORM\Table(name="assistance1")
 * @ORM\Entity(repositoryClass="Cosanit\CosanitBundle\Repository\Assistance1Repository")
 */
class Assistance1
{
    /**
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Categories", inversedBy="assistance1", cascade={"all"})
