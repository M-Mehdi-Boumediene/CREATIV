 ...
 * Assistance2
 *
 * @ORM\Table(name="assistance2")
 * @ORM\Entity(repositoryClass="Cosanit\CosanitBundle\Repository\Assistance2Repository")
 */
class Assistance2
{
    /**
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Categories", inversedBy="assistance2", cascade={"all"})
