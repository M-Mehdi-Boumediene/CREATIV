 ...
 * Incendies
 *
 * @ORM\Table(name="incendies")
 * @ORM\Entity(repositoryClass="Cosanit\CosanitBundle\Repository\IncendiesRepository")
 */
class Incendies
{
    /**
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Categories", inversedBy="incendies", cascade={"persist"})
