 ...
 * @ORM\Entity(repositoryClass="Cosanit\CosanitBundle\Repository\PartenairesRepository")
 */
class Partenaires implements VisitableInterface
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Types", inversedBy="partenaires", cascade={"persist"})
     *
     */
    protected $types;
