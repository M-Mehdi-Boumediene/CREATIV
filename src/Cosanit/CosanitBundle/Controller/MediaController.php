...
use Cosanit\CosanitBundle\Entity\Media;
...
class MediaController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $media = $em->getRepository('CosanitBundle:Media')->findAll();
    ...
    {
        $medium = new Media();
        $form = $this->createForm('Cosanit\CosanitBundle\Form\MediaType', $medium);
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('admin_medias_show', array('id' => $medium->getId()));
        }
    ...
    {
        $deleteForm = $this->createDeleteForm($medium);
        $editForm = $this->createForm('Cosanit\CosanitBundle\Form\MediaType', $medium);
        ...
        if ($editForm->isSubmitted() && $editForm->isValid()) {
            ...
            return $this->redirectToRoute('admin_medias_edit', array('id' => $medium->getId()));
        }
    ...
    private function createDeleteForm(Media $medium)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('admin_medias_delete', array('id' => $medium->getId())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
