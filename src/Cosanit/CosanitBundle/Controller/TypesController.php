...
use Cosanit\CosanitBundle\Form\TypesType;
...
class TypesController extends Controller
{
    ...
    {
        $type = new Types();
        $form = $this->createForm('Cosanit\CosanitBundle\Form\TypesType', $type);
    ...
    {
        $deleteForm = $this->createDeleteForm($type);
        $editForm = $this->createForm('Cosanit\CosanitBundle\Form\TypesType', $type);
