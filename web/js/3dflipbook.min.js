        ...
        VisualWorld = function(_THREE$EventDispatche) {
            function VisualWorld(wnd, doc, container) {
                ...
                _this.camera.position.x = 0, _this.camera.position.y = 27.5, _this.camera.position.z = 0, _this.renderer = new _libs.THREE.WebGLRenderer({
                    ...
                    margin: 0,
                    padding: 0
                }), _this.jContainer.append(_this.cssRenderer.domElement), _this.element = _this.cssRenderer.domElement, _this.textureLoader = new _libs.THREE.TextureLoader, _this.scene.add(new _libs.THREE.AmbientLight(13684944)), _this.light = new _libs.THREE.DirectionalLight(4210752, 1), _this.light.position.set(0, 30, 0), _this.light.castShadow = !1, _this.scene.add(_this.light), _this.controls = new _Orbit2.default(_this.camera, _this.element), _this.controls.target.y = .5;
            ...
            return _inherits(VisualWorld, _THREE$EventDispatche), VisualWorld.prototype.updateThree = function() {
